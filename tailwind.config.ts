    ...
    extend: {
      colors: {
        linear: {
          ...
          todo: "#d9d9d9", // violet-300  — visible light violet
          inProgress: "#353ff6", // violet-500
          done: "#2ac913", // violet-700

          // ─── Release Status — violet/fuchsia ───────────────────────────────
          overdueSolid: "#d82f2f", // fuchsia-600 (was red)
          upcomingGold: "#7C3AED", // violet-700  (was amber)
          overdueLight: "#fff", // pair with /10
        },
      },
      boxShadow: {
        "linear-xs": "0 1px 2px rgba(12,12,30,0.06)",
        "linear-sm":
          "0 1px 4px rgba(12,12,30,0.08), 0 1px 2px rgba(12,12,30,0.04)",
        "linear-hover":
          "0 8px 24px rgba(12,12,30,0.12), 0 2px 8px rgba(12,12,30,0.06)",
        "linear-card":
          "0 2px 8px rgba(12,12,30,0.08), 0 1px 3px rgba(12,12,30,0.04)",
        popover:
          "0 16px 48px rgba(12,12,30,0.16), 0 4px 16px rgba(12,12,30,0.08)",
        panel: "-4px 0 24px rgba(12,12,30,0.10)",
        "btn-active": "0 1px 3px rgba(12,12,30,0.12)",
        "accent-glow": "0 0 0 3px rgba(91,79,232,0.15)",
        "primary-glow":
          "0 0 0 4px rgba(91,79,232,0.12), 0 4px 16px rgba(91,79,232,0.10)",
      },
      fontFamily: {
