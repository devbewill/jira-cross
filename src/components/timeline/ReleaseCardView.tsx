...
function ReleaseCard({
  ...
  return (
    <div
      className='bg-card border-border hover:bg-muted/30 flex h-full cursor-pointer flex-col gap-2 rounded-xs border p-4 transition-all select-none'
      style={
        isSelected
        ...
        {months.map((group) => (
          <section key={group.key}>
            <div className='border-border mb-3 flex items-center gap-3 border-b pb-2'>
              <h3 className='text-foreground text-sm font-bold'>{group.label}</h3>
