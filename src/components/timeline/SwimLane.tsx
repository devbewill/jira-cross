...
export function SwimLane({
  ...
  return (
    <div className="flex gap-0 h-full border-b border-linear-border/30 group">
      ...
      <div className="w-56 flex-shrink-0 bg-linear-bg border-r border-linear-border/50 flex flex-col justify-center px-4 py-4 sticky left-0 z-30 group-hover:bg-linear-surfaceHover/10 transition-colors">
