      ...
      <header className="flex items-center justify-between px-6 py-4 bg-linear-surface flex-shrink-0 border-b border-linear-border shadow-linear-sm">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="flex  bg-linear-accent text-white hover:bg-linear-accentHover items-center gap-2 px-4 py-2 rounded-lg text-[12px] font-semibold transition-all duration-150 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {isRefreshing ? (
              <>
